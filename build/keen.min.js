...
}var n=e.toPrecision(3);if(Number(n)==e&&4>=(e+"").length)return e+"";if(e>=1||-1>=e){var i="";0>e&&(e=-e,i="-");var r=["","k","M","B","T"];return i+t(e,0)}return e.toPrecision(3)},Date.prototype.stdTimezoneOffset=function(){var e=new Date(this.getFullYear(),-1,1),t=new Date(this.getFullYear(),6,1);return Math.max(e.getTimezoneOffset(),t.getTimezoneOffset())},Date.prototype.dst=function(){return this.getTimezoneOffset()<this.stdTimezoneOffset()},Keen.loadedCallback&&"function"==typeof Keen.loadedCallback&&Keen.loadedCallback()}();